...
<head>
    ...
    <title>Register - Direktori Faskes</title>
            ...
            <div class="card shadow-lg bg-white rounded-4 border-0 animate__animated animate__fadeInUp">
                <div class="card-body">
                    <div class="text-center mb-5">
                        <h2 class="card-title fw-bold text-dark display-6 mb-2" style="font-size: 1.75rem;">Direktori <span class="text-primary">Faskes</span></h2>
                        <p class="text-muted lead mb-0" style="font-size: 0.9rem;">Silakan isi data Anda untuk membuat akun.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-md border-primary rounded-pill overflow-hidden shadow-sm-sm">
                                <span class="input-group-text bg-white border-0 text-primary" style="font-size: 0.9rem;"><i class="bi bi-person-fill"></i></span>
                                <input id="name" class="form-control border-0 @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Nama Anda">
                            </div>
                            @error('name')
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-md border-primary rounded-pill overflow-hidden shadow-sm-sm">
                                ...
                                <input id="email" class="form-control border-0 @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="contoh@domain.com">
                            </div>
                            @error('email')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-md border-primary rounded-pill overflow-hidden shadow-sm-sm">
                                ...
                                <input id="password" class="form-control border-0 @error('password') is-invalid @enderror" type="password" name="password" required autocomplete="new-password" placeholder="••••••••">
                            </div>
                            @error('password')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label fw-semibold text-muted">Konfirmasi Password</label>
                            <div class="input-group input-group-md border-primary rounded-pill overflow-hidden shadow-sm-sm">
                                <span class="input-group-text bg-white border-0 text-primary" style="font-size: 0.9rem;"><i class="bi bi-lock-fill"></i></span>
                                <input id="password_confirmation" class="form-control border-0 @error('password_confirmation') is-invalid @enderror" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi password">
                            </div>
                        ...
                        <p class="text-center text-muted mt-3 mb-0">
                            Sudah punya akun? <a href="{{ route('login') }}" class="text-primary text-decoration-none fw-semibold">Login di sini.</a>
                        </p>
                    </form>
                </div>
            </div>
